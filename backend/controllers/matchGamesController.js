...
async function deleteGame(req, res) {
  ...
  await dbRun(db, "DELETE FROM match_games WHERE id = ?", [gameId]);

  res.json({ deleted: gameId });
}
...
module.exports = { listByMatch, create, createAuto, deleteGame, addGoal, deleteGoal };
